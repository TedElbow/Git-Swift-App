...
/// Holds the app view model built from the launch container. Created once when LittleStreakUp initializes.
@MainActor
...
/// so LittleStreakUp can read it once to build the view model and inject into the hierarchy. No global singleton.
@main
@MainActor
struct LittleStreakUp: App {
